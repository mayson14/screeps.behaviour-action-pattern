...
mod.analyze = function(){
    const p = startProfiling('Population.analyze', {enabled:PROFILING.CREEPS});
    let register = entry => {
...
mod.execute = function(){
    const p = startProfiling('Population.execute', {enabled: PROFILING.CREEPS});
...
mod.cleanup = function(){
    const p = startProfiling('Population.cleanup', {enabled: PROFILING.CREEPS});
